...
export const MODEL_GROUPS: ModelGroup[] = [
  {
    ...
    models: [
      { value: 'openrouter/qwen/qwen-2.5-coder-32b-instruct:free', label: 'Qwen 2.5 Coder 32B (free) - RECOMMENDED', provider: 'openrouter', free: true },
      ...
      { value: 'openrouter/deepseek/deepseek-r1:free', label: 'DeepSeek R1 (free) - High Load/Rate-limited', provider: 'openrouter', free: true },
